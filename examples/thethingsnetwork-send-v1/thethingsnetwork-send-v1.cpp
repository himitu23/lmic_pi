...
static const u1_t APPEUI[8]  = { 0xBA, 0x7C, 0x01, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };

// LoRaWAN DevEUI, unique device ID (LSBF)
// Not used in this example
static const u1_t DEVEUI[8]  = { 0x1D, 0x2B, 0xD1, 0xFB, 0x6B, 0xFC, 0xF8, 0x00 };

// LoRaWAN NwkSKey, network session key 
// Use this key for The Things Network
static const u1_t DEVKEY[16] = { 0x6B, 0x89, 0xC5, 0x0A, 0x41, 0x25, 0x5B, 0x56, 0xB8, 0xC4, 0x63, 0xB2, 0x8E, 0x4B, 0xF6, 0x7C };

// LoRaWAN AppSKey, application session key
// Use this key to get your data decrypted by The Things Network
static const u1_t ARTKEY[16] = { 0xF3, 0x68, 0x30, 0x4A, 0x27, 0xEC, 0xDA, 0xE7, 0x1C, 0xF9, 0x89, 0xC8, 0x25, 0xAD, 0x6F, 0xED };
...
void setup() {
  ...
  LMIC_setDrTxpow(DR_SF10,13); /*modified by himitu23 for AS923*/
  //
}
